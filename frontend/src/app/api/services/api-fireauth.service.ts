...
import { RefreshAllFirebaseUserdataFireauthRefreshAllPost$Params } from '../fn/fireauth/refresh-all-firebase-userdata-fireauth-refresh-all-post';
...
export class apiFireauthService extends BaseService {
  ...
  /** Path part for operation `refreshAllFirebaseUserdataFireauthRefreshAllPost()` */
  static readonly RefreshAllFirebaseUserdataFireauthRefreshAllPostPath = '/fireauth/refresh_all';

  /**
   * Refresh All Firebase Userdata.
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `refreshAllFirebaseUserdataFireauthRefreshAllPost()` instead.
   *
   * This method doesn't expect any request body.
   */
  refreshAllFirebaseUserdataFireauthRefreshAllPost$Response(params?: RefreshAllFirebaseUserdataFireauthRefreshAllPost$Params, context?: HttpContext): Observable<StrictHttpResponse<any>> {
    return refreshAllFirebaseUserdataFireauthRefreshAllPost(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `refreshAllFirebaseUserdataFireauthRefreshAllPost$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
